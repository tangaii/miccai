...
class SpatialQuantileRefinementHead(nn.Module):
    """Coordinate-aware four-query head returning ordered Q25/Q50/Q75 values."""
...
def make_spatial_quantile_head() -> SpatialQuantileRefinementHead:
    """Compatibility factory for :class:`SpatialQuantileRefinementHead`."""

    return SpatialQuantileRefinementHead()


SpatialQuantileHead = SpatialQuantileRefinementHead


__all__ = ["SpatialQuantileHead", "SpatialQuantileRefinementHead", "make_spatial_quantile_head"]
